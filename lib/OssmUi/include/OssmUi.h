...
class OssmUi
{
   public:
    ...
    void UpdateStateL(const int speed_percentage);
    void UpdateStateR(const int encoder_position);
    void UpdateTitelL( String l_titel_in);
    void UpdateTitelR( String r_titel_in);
