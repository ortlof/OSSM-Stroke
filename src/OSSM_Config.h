...
#define MAX_RPM           3500.0    // Maximum RPM of motor
#define MAX_ACCELERATION  20000     // Maximum linear acceleration in mm/s²
...
#define MAX_STROKEINMM 150.0  // Real physical travel from one hard endstop to the other
